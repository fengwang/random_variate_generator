...
\begin{center}
\fcolorbox{White}{Silver}{\textcolor{Sepia}{\textbf{g++ -I\textit{PATH\_TO\_THE\_HEADER} -o test\_gaussian test\_gaussian.cc -std=c++11 -Wall}}}
\end{center}
...
\begin{figure}
\centering
\fbox{\includegraphics[scale=0.4]{gauss}}
